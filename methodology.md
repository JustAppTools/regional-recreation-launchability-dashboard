...
3. Keep a USGS 12436000 site catalog snapshot as official station metadata and use the USGS daily values endpoint as a fallback if Reclamation parsing fails.
